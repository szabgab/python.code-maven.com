...
- [Pytest Mocking Hard-coded path](./pytest-hard-coded-path.md)
...
- [Pytest: Mocking external API call](./pytest-mocking-slow-external-call.md)
  - [Pytest: Mocking external API call - manually replace function](./pytest-mocking-slow-external-call-manually-replace.md)
  - [Pytest: Mocking external API call - monkeypatch](./pytest-mocking-slow-external-call-monkeypatch.md)
  - [Pytest: Mocking broken external API response](./pytest-mocking-slow-external-call-manually-replace-broken-remote.md)
...
- [Pytest: Mocking environment variables](./pytest-mocking-environment-variables.md)
  - [Pytest: Mocking The PATH environment variable](./pytest-mocking-path-environment-variable.md)
