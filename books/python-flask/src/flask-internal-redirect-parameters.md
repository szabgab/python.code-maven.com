...
{% embed include file="src/examples/flask/redirect-with-parameters/redirect_parameters.py" %}

{% embed include file="src/examples/flask/redirect-with-parameters/test_redirect_parameters.py" %}
