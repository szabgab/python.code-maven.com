...
look like a mess if you opened them in Notepad.
...
In Python you have specialized modules for each well-known binary type to handle the files of that format. Text files on the other
