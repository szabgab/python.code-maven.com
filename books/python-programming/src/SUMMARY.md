...
- [Comparison and Boolean](./boolean.md)
  ...
  - [Chained expressions](./chained-expressions.md)
...
- [Strings](./strings.md)
  ...
  - [Multi-line strings](./multiline-strings.md)
...
- [Lists](./lists.md)
  ...
  - [Exercise: Queue](./exercise-queue.md)
...
- [Code Reuse](./code-reuse/index.md)
  ...
  - [Permutations - factorial function](./code-reuse/permutations-factorial-function.md)
...
- [Functions (subroutines)](./functions/index.md)
  ...
  - [Fixed parameters before the others](./functions/fixed-and-variable-length-argument-list.md)
  ...
  - [Set recursions limit](./functions/set-recursion-limit.md)
  ...
  - [Variable assignment and change - Mutable dict](./functions/assignment-details-dict.md)
...
- [Modules](./modules/index.md)
  ...
  - [Exercise: Scripts and modules](./modules/exercise-functional-scripts-and-modules.md)
...
- [time](./time/index.md)
  ...
  - [datetime arithmetics (subtract)](./datetime/datetime-arithmetics-subtract.md)
  - [Timezone aware datetime](./datetime/timezone-aware-datetime.md)
  - [datetime arithmetics (compare, sort)](./datetime/datetime-arithmetics-compare-dates.md)
  - [datetime arithmetics (addition)](./datetime/datetime-arithmetics.md)
...
- [Command line arguments with argparse](./argparse/index.md)
  ...
  - [argparse print help explicitly](./argparse/argparse-print-help.md)
  - [Argparse xor - mutual exclusive - only one - exactly one](./argparse/argparse-xor.md)
...
- [YAML](./yaml/index.md)
  - [YAML - YAML Ain't Markup Language](./yaml/what-is-yaml.md)
